...
class MetadataOverviewTuneFileValue(models.Model):
    ...
    metadata = models.ForeignKey(MetadataOverview, related_name='%(class)s_metadataOverview')
    ...
    sheath_gas_flow = models.IntegerField()

    aux_gas_flow = models.IntegerField()

    sweep_gas_flow = models.IntegerField()
...
class MetadataOverviewCalibrationFileValue(models.Model):
    ...
    cap_device_max_v = models.FloatField()

    tube_lens_device_min_v = models.FloatField()

    tube_lens_device_max_v = models.FloatField()
